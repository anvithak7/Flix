...
- (void)fetchSimilarMovies {
    ...
    NSString *similarURLHalf = [@"https://api.themoviedb.org/3/movie/ stringByAppendingString:backdropURLString" stringByAppendingString:[NSString stringWithFormat:@"%@",self.movie[@"movie_id"]]];
